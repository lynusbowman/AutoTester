...
lov = "SERVICE"
ID = 317
title = "Neomezené přehrávání"
paramIDs = [1824]
paramTitles = ["Sleva"]
paramDataTypes = [7]
paramRequired = [1]
param1824Values = ["0%", "25%", "50%", "75%", "100%"]
offerIDs = [500244353, 500244433]
offerTitles = ["Neomezene prehravani", "D_Vodefend2"]
 ...
 **********************************/
  for (j in 0 .. paramIDs.size()-1) {
    ...
    assert util.check("Values for param " + paramIDs[j], values, param1824Values, param1824Values)  == 1               
