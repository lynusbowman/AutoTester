...
attrValues = ["25000", "Z1=100,Z1-3=200,Z1-9=300,", "INT=100,CZ=200,", "Z1=100,Z1-2=200,Z1-3=300,", "Z1=100,Z1-2=200,Z1-3=300,",
              "Z1=100,Z1-2=200,Z1-3=300,", "1000", "A", "N", "N", "N", "N", "8000MB", "2000", "3000", "CZ=100,"]
srvID = 896
 ...
 **********************************/
util.log("Activation")  
papi = util.clf.callPAPI(level, CU, ID, "a", [attrIDs[0], attrIDs[7]], ["0", attrValues[7]])
assert papi != null 

/**********************************
           Modification - check via PAPI, CLF, DWH
 **********************************/
...
assert papi != null
assert util.check("Get after modification PNM1", papi.getOutAttributes(), attrIDs, 
...
assert util.check("Get after modification all", [papi.getStatus(), papi.getAttr(1485)], ["a", attr1485Value]) == 1    
